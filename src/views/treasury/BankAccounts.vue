...
<template>
    <div class="treasury-view">
        <div class="main-card">
            ...
            <DataTable :value="bankAccounts" :paginator="true" :rows="10" dataKey="id" :filters="filters" :loading="loading" showGridlines responsiveLayout="scroll" :emptyMessage="undefined" class="modern-datatable">
                <template #empty>
            ...
            <Dialog v-model:visible="accountDialog" :style="{ width: '560px' }" :modal="true" :closable="true" class="account-dialog" @hide="hideDialog">
                ...
                <div class="dialog-body">
                    ...
                    <div class="form-field">
                        ...
                        <Dropdown id="bank_id" v-model="account.bank_id" :options="banks" optionLabel="name" optionValue="id" placeholder="Seleccione una entidad bancaria" filter :class="['w-full', { 'p-invalid': submitted && !account.bank_id }]" />
                        <small class="p-error" v-if="submitted && !account.bank_id"> <i class="pi pi-exclamation-circle mr-1"></i>El banco es requerido. </small>
                    </div>
                    ...
                    <div class="form-field">
                        ...
                        <InputText id="description" v-model.trim="account.description" placeholder="Ej: Cuenta Principal Soles" class="form-input" :class="{ 'p-invalid': submitted && !account.description }" />
                        <small class="p-error" v-if="submitted && !account.description"> <i class="pi pi-exclamation-circle mr-1"></i>La descripción es requerida. </small>
                    </div>

                    <!-- Separador: Identificadores -->
                    <div class="section-divider">
                        <span class="section-divider-label"> <i class="pi pi-hashtag mr-1"></i>Identificadores de Cuenta </span>
                    </div>
                    ...
                    <div class="form-field">
                        ...
                        <InputText id="code" v-model.trim="account.code" placeholder="Ej: BCP-001" class="form-input font-mono" />
                    </div>
                    ...
                    <div class="form-grid-2">
                        <div class="form-field">
                            ...
                            <InputText id="account_number" v-model.trim="account.account_number" placeholder="Ej: 19120456789078" class="form-input font-mono" :class="{ 'p-invalid': submitted && !account.account_number }" />
                        ...
                        <div class="form-field">
                            ...
                            <InputText id="cci" v-model.trim="account.cci" placeholder="Ej: 00219100456789078015" class="form-input font-mono" :class="{ 'p-invalid': submitted && !account.cci }" />
                    ...
                    <div class="section-divider">
                        <span class="section-divider-label"> <i class="pi pi-sliders-h mr-1"></i>Configuración </span>
                    </div>
                    ...
                    <div class="form-grid-2">
                        <div class="form-field">
                            ...
                            <Dropdown id="currency" v-model="account.currency" :options="currencies" optionLabel="label" optionValue="value" class="w-full" />
                        </div>
                        <div class="form-field">
                            ...
                            <Dropdown id="account_type" v-model="account.account_type" :options="accountTypes" optionLabel="label" optionValue="value" class="w-full" />
                        </div>
                    </div>
                    ...
                    <div class="form-grid-2">
                        <div class="form-field">
                            ...
                            <InputNumber id="initial_balance" v-model="account.initial_balance" mode="currency" :currency="account.currency === 'USD' ? 'USD' : 'PEN'" locale="es-PE" class="w-full" :disabled="!!account.id" />
                            <small class="hint-text" v-if="!account.id"> <i class="pi pi-info-circle mr-1"></i>Solo se puede establecer al crear. </small>
                            <small class="hint-text" v-else> <i class="pi pi-lock mr-1"></i>El saldo inicial no es editable. </small>
                        </div>
                        <div class="form-field">
            ...
            <Dialog v-model:visible="deleteAccountDialog" :style="{ width: '450px' }" header="Confirmar eliminación" :modal="true">
                <div class="flex align-items-center gap-3">
                    ...
                    <span v-if="account"
                        >¿Estás seguro que deseas eliminar la cuenta <b>{{ account.description }}</b
                        >?</span
                    >
                </div>
                <template #footer>
...
/* ============================================================================
   DIALOG STYLES
   ============================================================================ */
:deep(.account-dialog .p-dialog-header) {
    padding: 1.5rem 1.5rem 0 1.5rem;
    border-bottom: none;
}
:deep(.account-dialog .p-dialog-content) {
    padding: 0;
}
:deep(.account-dialog .p-dialog-footer) {
    padding: 0;
