...
export const PERMISSION_GROUPS = {
    ...
    ADMINISTRATIVE_STAFF: [POSITIONS.ADMINISTRACION, POSITIONS.ADMISION, POSITIONS.RRHH, POSITIONS.CONTABILIDAD, POSITIONS.FACTURACION],
    ...
    SYSTEM_ADMIN: [POSITIONS.SISTEMAS, POSITIONS.ADMINISTRACION],

    // Acceso completo
    ALL_ACCESS: [POSITIONS.SISTEMAS, POSITIONS.DIRECTOR_MEDICO, POSITIONS.ADMINISTRACION],
