...
export const PERMISSION_GROUPS = {
    // Personal médico
    MEDICAL_STAFF: [
        USER_POSITIONS.MEDICOS,
        USER_POSITIONS.DIRECTOR_MEDICO,
        USER_POSITIONS.EMERGENCIA
    ],
    
    // Personal administrativo
    ADMINISTRATIVE_STAFF: [
        USER_POSITIONS.ADMINISTRACION,
        USER_POSITIONS.ADMISION,
        USER_POSITIONS.RRHH,
        USER_POSITIONS.CONTABILIDAD,
        USER_POSITIONS.FACTURACION
    ],
    
    // Personal técnico
    TECHNICAL_STAFF: [
        USER_POSITIONS.LABORATORIO,
        USER_POSITIONS.RAYOS_X,
        USER_POSITIONS.FARMACIA,
        USER_POSITIONS.QUIROFANO
    ],
    
    // Personal de apoyo
    SUPPORT_STAFF: [
        USER_POSITIONS.ARCHIVO_HISTORIAS,
        USER_POSITIONS.HOSPITALIZACION,
        USER_POSITIONS.LOGISTICA
    ],
    
    // Administradores del sistema
    SYSTEM_ADMIN: [
        USER_POSITIONS.SISTEMAS,
        USER_POSITIONS.ADMINISTRACION
    ],
