...
export const PERMISSION_GROUPS = {
    ...
    BED_RESERVATIONS_STAFF: [POSITIONS.SISTEMAS, POSITIONS.DIRECTOR_MEDICO, POSITIONS.ADMINISTRACION, POSITIONS.MEDICOS, POSITIONS.EMERGENCIA, POSITIONS.HOSPITALIZACION, POSITIONS.QUIROFANO, POSITIONS.ADMISION, POSITIONS.COORDINADOR_HOSPITALIZACION],
