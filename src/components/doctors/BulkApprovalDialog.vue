...
watch(() => selectedServices.value.length, (newLength) => {
...
<template>
    <Dialog
        ...
        modal
        :header="`Aprobar/Rechazar Atenciones - ${doctorName}`"
    ...
    >
                ...
                <div class="info-card">
                    ...
                    <div>
                        ...
                        <small class="text-muted">
                            (Se excluyen atenciones ya aprobadas o rechazadas)
                        </small>
                    </div>
                </div>
                ...
                >
                    <template #header>
                        <div class="table-header">
                            ...
                            <Tag
                                :value="`${selectedCount} seleccionados`"
                                :severity="selectedCount > 0 ? 'success' : 'secondary'"
                            />
                        </div>
                    </template>
                    ...
                    <Column field="serviceType" header="Tipo" sortable style="min-width: 100px">
                        <template #body="slotProps">
                            <Tag
                                ...
                                :severity="slotProps.data.serviceType === 'PLANILLA' ? 'success' : 'warning'"
                            />
                        </template>
                    </Column>
        ...
        <template #footer>
            <div class="dialog-footer">
                ...
                />
                <Button
                    :label="`Actualizar ${selectedCount} atención${selectedCount !== 1 ? 'es' : ''}`"
                    icon="pi pi-check"
                    @click="handleApprove"
