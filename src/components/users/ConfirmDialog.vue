    ...
    >
        ...
        <div class="confirmation-content">
            <div class="flex align-items-start gap-3 mb-4">
                <div 
                    class="w-3rem h-3rem border-circle flex align-items-center justify-content-center flex-shrink-0"
                ...
                <div class="flex-1">
                    ...
                    <div v-if="user" class="surface-100 border-round p-3 mt-3">
                        <div class="flex align-items-center gap-3">
                            <div 
                                class="w-2rem h-2rem border-circle flex align-items-center justify-content-center text-white font-bold text-sm"
                            ...
                            <div>
                                ...
                                <div class="text-600 text-sm">
                                    {{ user.email }} • {{ formatPositionLabel(user.position) }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="requireTextConfirmation" class="mt-3">
                        <label class="block font-medium text-900 mb-2">
                            Para confirmar, escriba "{{ confirmationText }}" en el campo de abajo:
                        </label>
                        <InputText 
                            v-model="textConfirmation"
                            placeholder="Escriba aquí para confirmar..."
                            class="w-full"
                            :class="{ 'p-invalid': textConfirmation && textConfirmation !== confirmationText }"
                        />
                        <small v-if="textConfirmation && textConfirmation !== confirmationText" class="p-error">
        ...
        <template #footer>
            <div class="flex justify-content-between align-items-center">
                ...
                <div class="flex gap-2 ml-auto">
                    ...
                    <Button 
                        :label="confirmLabel" 
                        :icon="processing ? 'pi pi-spin pi-spinner' : confirmIcon"
                        :class="buttonClass"
                        @click="confirm"
                        :loading="processing"
                        :disabled="!canConfirm"
